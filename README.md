...
| hormigasais-edge-starter | Producto comercial | `Thrumanshow/hormigasais-edge-starter` (GitHub) | ✅ Producción |
...
![HormigasAIS Architecture Overview](./evidence/assets/architecture-overview-v0.2.0.png)
